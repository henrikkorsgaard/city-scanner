...
func (e *Experiment) GenerateConfigurationFile() (configs []byte) {
	...
	iniString.WriteString("#As a bare minimum, you need to supply a name and unique id for each node, as well as the server to upload to." + linebreak + linebreak)
	...
	iniString.WriteString("[Experiment]" + linebreak)
	...
	iniString.WriteString("[Node]" + linebreak)
	iniString.WriteString("name=" + linebreak)
	iniString.WriteString("id=" + linebreak + linebreak)

	iniString.WriteString("[Network]" + linebreak)
	iniString.WriteString("ssid=" + linebreak)
	iniString.WriteString("password=" + linebreak + linebreak)
	iniString.WriteString("[Server]" + linebreak)
	iniString.WriteString("server_url=" + linebreak + linebreak) //TODO add this server
