...
func (e *Experiment) GenerateConfigurationFile() (configs []byte) {
	...
	iniString.WriteString("#This configuration file is generated by city-scanner.\n")
	iniString.WriteString("#Please consult the online guide on how to configure the sensing node.\n\n")
	iniString.WriteString("#The network configuration section supports add network information for the sensing node to connect to the server for data upload.\n")
	iniString.WriteString("[Experiment Information]\n")
	...
	iniString.WriteString("[Network Configuration]\n")
	iniString.WriteString("ssid=\n")
	iniString.WriteString("password=\n\n")
	iniString.WriteString("[Server information]\n")
	iniString.WriteString("server_url=\n") //TODO add this server
	iniString.WriteString("upload_frequency_seconds=600\n\n")
	iniString.WriteString("[Security]\n")
	iniString.WriteString("salt=")
	iniString.WriteString(e.NodeSalt)
	iniString.WriteString("\n")
	iniString.WriteString("publickey=")
